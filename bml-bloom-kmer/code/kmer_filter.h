 ...
 */
size_t kmerf_populate(kmer_filter_t *kf, Text T);
 ...
 */
kmer_filter_t *kmerf_load_file(char *filename);

/**
 * Write a kmer_filter to a binary file.
 */
kmer_filter_t *kmerf_save_file(char *filename, kmer_filter_t *kf);
